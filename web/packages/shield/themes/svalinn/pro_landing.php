...
<body class="antialiased<?php echo $bodyClasses; ?> professional">
	<!--[if lte IE 8]>
		...
		<div class="inner-wrap">
			<div class="main-wrap">
				...
				<article class="container main">
					...
					<div class="row section-2 outdent-both">
						<div class="column medium-6 col-left">
							<img src="/packages/shield/img/professional/professional-left.jpg"/>
							<div class="details"><?php $a = new Area('Main Left'); $a->display($c); ?></div>
						</div>
						<div class="column medium-6 col-right">
							<img src="/packages/shield/img/professional/professional-right.jpg"/>
							<div class="details"><?php $a = new Area('Main Right'); $a->display($c); ?></div>
						</div>
					</div>
					<div class="row section-3">
						<img src="/packages/shield/img/professional/bg-footer.jpg"/>
					</div>
				</article>
				<!-- END .content -->
				<!-- BEGIN .footer -->
